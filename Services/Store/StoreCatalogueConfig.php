...
class StoreCatalogueConfig {
  ...
  const BRAND_IDENTIFIABLE_CATEGORIES_WAY = self::CATALOGUE_CONFIGURATION_BRANDS . "/brand_identifiable_categories_way";
  const BRAND_IDENTIFIABLE_CATEGORIES_LEVEL = self::CATALOGUE_CONFIGURATION_BRANDS . "/brand_identifiable_categories_level";
  const BRAND_IDENTIFIABLE_CATEGORIES_SELECTION = self::CATALOGUE_CONFIGURATION_BRANDS . "/brand_identifiable_categories_selection";

  const BRAND_IDENTIFIABLE_ATTRIBUTE_SELECTION = self::CATALOGUE_CONFIGURATION_BRANDS . "/brand_identifiable_attribute_selection";
  ...
  const GENDER_IDENTIFIABLE_CATEGORIES_PARENT_CONSIDERATION = self::CATALOGUE_CONFIGURATION_GENDER . "/genders_identifiable_by_categories_parent_consideration";
  ...
  const COLORS_IDENTIFIABLE_ATTRIBUTES = self::CATALOGUE_CONFIGURATION_COLORS . "/colors_identifiable_attributes_selection";
  ...
  const SIZES_IDENTIFIABLE_ATTRIBUTES = self::CATALOGUE_CONFIGURATION_SIZES . "/sizes_identifiable_attributes_selection";
  ...
  public function genderIdentityConsiderParentCategories() {
    return ($this->configManager->getStoreConfig(self::GENDER_IDENTIFIABLE_CATEGORIES_PARENT_CONSIDERATION, $this->storeId)) ? TRUE : FALSE;
  }
