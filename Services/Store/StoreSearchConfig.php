...
class StoreSearchConfig {
   ...
   const WIZZY_SEARCH_RESULTS_CONFIGURATION = self::WIZZY_SEARCH_CONFIGURATION . "/search_results_general_configuration";
   ...
   const WIZZY_INCLUDE_OUT_OF_STOCK_PRODUCTS = self::WIZZY_SEARCH_RESULTS_CONFIGURATION . "/include_out_of_stock_products";
   ...
   const WIZZY_SORT_CONFIGURATION = self::WIZZY_SEARCH_SORT_CONFIGURATION . "/sorts_configuration";

   const WIZZY_PAGINATION_CONFIGURATION = self::WIZZY_SEARCH_CONFIGURATION . "/search_results_pagination_configuration";
   const WIZZY_PAGINATION_TYPE = self::WIZZY_PAGINATION_CONFIGURATION . "/pagination_type";
   const WIZZY_PAGINATION_MOVE_TO_TOP_WIDGET = self::WIZZY_PAGINATION_CONFIGURATION . "/pagination_move_to_top_widget";

   const WIZZY_SEARCH_SWATCHES_CONFIGURATION = self::WIZZY_SEARCH_CONFIGURATION . "/search_results_swatches_configuration";
   ...
   public function getSwatchesConfiguration() { 
      $swatchesConfiguration = $this->configManager->getStoreConfig(self::WIZZY_SWATCHES_CONFIGURATION, $this->storeId);
