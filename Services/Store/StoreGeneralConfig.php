...
class StoreGeneralConfig
{
   ...
   // General section configuration
    ...
    const CUSTOM_ENDPOIONT = self::WIZZY_GENERAL_SECTION_CONFIGURATION . "/custom_endpoint";
    ...
    {
        return $this->configManager->getStoreConfig(self::CUSTOM_ENDPOIONT, $this->storeId);
    }
