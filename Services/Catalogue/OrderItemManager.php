...
class OrderItemManager {
   ...
   public function __construct(OrderItemRepositoryInterface $orderItemRepository, SearchCriteriaInterface $searchCriteriaInterface, FilterGroup $filterGroup, FilterBuilder $filterBuilder) {
