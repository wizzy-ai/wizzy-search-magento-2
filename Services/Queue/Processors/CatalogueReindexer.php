...
class CatalogueReindexer extends QueueProcessorBase {
   ...
   public function __construct(IndexerManager $indexerManager, StoreGeneralConfig $storeGeneralConfig, EntitiesSync $entitiesSync, ProductsManager $productsManager) {
