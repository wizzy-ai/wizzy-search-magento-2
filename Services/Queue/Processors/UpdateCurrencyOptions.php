...
class UpdateCurrencyOptions extends QueueProcessorBase {
   ...
   public function __construct(StoreManager $storeManager, StoreGeneralConfig $storeGeneralConfig, CurrencyManager $currencyManager, Currency $currency) {
