...
class CategoriesObserver {
    ...
    */
   public function afterSave(CategoryResourceModel $categoryResourceModel, CategoryResourceModel $resourceModelResult, CategoryMainModel $category) {
    ...
    */
   public function beforeDelete(ResourceCategoryInterceptor $categoryResourceModel, CategoryInterceptor $categoryInterceptor) {
